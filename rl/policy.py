...
class DirectReinforcementLearning:
    ...
    def gradientAscent(self):
        ...
        returns, sharpe_ratio = of.Returns(self._feature_vector['Fermeture'], pd.Series(self._position).round()).getAdditiveProfits()
        ...
        while t < self._feature_vector.shape[0] - 1:
            ...
            dRdFp = returns[t] + self._tc * np.sign(self._position[t] - self._position[t-1])
